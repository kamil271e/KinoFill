    ...
    $("#actors-list").change(function(){
        ...
        if(selected_actors){
            ...
            $.each(selected_actors, function(index, actor){
                ...
                form_container.append('<label for="string-input">'+actor_name+' (character name)</label><br><input type="text" id="string-input" name="actor_'+index+'"><input type="hidden" name="actor_'+index+'_h" value="'+actor_id+'"><br><br>');
