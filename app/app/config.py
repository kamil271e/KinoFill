...
global init_genres
init_genres = ["Akcji", "Animacji", "Biograficzny", "Dramat", "Dokumentalny", "Erotyczny", "Fantasy", "Film noir", "Historyczny", "Horror", "Komedia", "Kryminał", "Melodramat", "Musical", "Sci-Fi", "Thriller", "Western", "Wojenny"]
